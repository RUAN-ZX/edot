...
class _GZXFilterGoodsPageState extends State<GZXFilterGoodsPage> {
  ...
  List<String> _value8 = ['11.6英寸', '12英寸', '12.1英寸', '13英寸', '13.3英寸', '14英寸', '15英寸', '15.4英寸', '15.6英寸', '17英寸', '17.3英寸'];
  List<String> _value9 = ['750GB', '512GB', '512GB', '纯固态512G', '500g', '500GB', '320GB', '256GB', '128GB', '128G', '2TB', '1TB', '无机械硬盘', '0'];
...
//      color: Colors.red,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(left: width, top: 0),
      color: Colors.white,
