...
import 'videoCardPlay.dart';
import 'GetUtilBilibili.dart';
import 'videoCardItemWidget.dart';
...
class _RecommendPageState extends State<RecommendPage>
    ...
    return Container(
        ...
        child: ClipRRect(
          ...
          child: GestureDetector(
            onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>blank())),
            child: Container(
  ...
  Future<Null> _onLoading() async {
    listData.addAll(await GetVideoList.getRecommend());
